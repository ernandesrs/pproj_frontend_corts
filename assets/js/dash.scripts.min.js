...
navLinksAnimation(){let navLinks=this.nav.querySelectorAll(".c-header-nav .c-header-nav-link");if(!navLinks)return;navLinks.forEach((item,key)=>{item.style.transitionDelay=(key*.125)+"s"})}};(new CHeader(".sidebar-toggler",".sidebar")).init();/*!
